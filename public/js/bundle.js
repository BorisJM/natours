...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYm9yaXNtYXRlbmNvMjMiLCJhIjoiY2xtbThpMmlpMGg1bjJyczdqcjVtNWg1diJ9.jqPfwFKEcrfg14FDWMPTbQ';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/borismatenco23/clmm9l9ym001901qndh4fapa9',
    // style URL
    scrollZoom: false
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 8:
          ...
          (0, _alerts.showAlert)('error', (_err$response = _context.t0.response) === null || _err$response === void 0 || (_err$response = _err$response.data) === null || _err$response === void 0 ? void 0 : _err$response.message);
        case 11:
        case "end":
...
function _regeneratorRuntime() { "use strict"; /*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/facebook/regenerator/blob/main/LICENSE */ _regeneratorRuntime = function _regeneratorRuntime() { return e; }; var t, e = {}, r = Object.prototype, n = r.hasOwnProperty, o = Object.defineProperty || function (t, e, r) { t[e] = r.value; }, i = "function" == typeof Symbol ? Symbol : {}, a = i.iterator || "@@iterator", c = i.asyncIterator || "@@asyncIterator", u = i.toStringTag || "@@toStringTag"; function define(t, e, r) { return Object.defineProperty(t, e, { value: r, enumerable: !0, configurable: !0, writable: !0 }), t[e]; } try { define({}, ""); } catch (t) { define = function define(t, e, r) { return t[e] = r; }; } function wrap(t, e, r, n) { var i = e && e.prototype instanceof Generator ? e : Generator, a = Object.create(i.prototype), c = new Context(n || []); return o(a, "_invoke", { value: makeInvokeMethod(t, r, c) }), a; } function tryCatch(t, e, r) { try { return { type: "normal", arg: t.call(e, r) }; } catch (t) { return { type: "throw", arg: t }; } } e.wrap = wrap; var h = "suspendedStart", l = "suspendedYield", f = "executing", s = "completed", y = {}; function Generator() {} function GeneratorFunction() {} function GeneratorFunctionPrototype() {} var p = {}; define(p, a, function () { return this; }); var d = Object.getPrototypeOf, v = d && d(d(values([]))); v && v !== r && n.call(v, a) && (p = v); var g = GeneratorFunctionPrototype.prototype = Generator.prototype = Object.create(p); function defineIteratorMethods(t) { ["next", "throw", "return"].forEach(function (e) { define(t, e, function (t) { return this._invoke(e, t); }); }); } function AsyncIterator(t, e) { function invoke(r, o, i, a) { var c = tryCatch(t[r], t, o); if ("throw" !== c.type) { var u = c.arg, h = u.value; return h && "object" == _typeof(h) && n.call(h, "__await") ? e.resolve(h.__await).then(function (t) { invoke("next", t, i, a); }, function (t) { invoke("throw", t, i, a); }) : e.resolve(h).then(function (t) { u.value = t, i(u); }, function (t) { return invoke("throw", t, i, a); }); } a(c.arg); } var r; o(this, "_invoke", { value: function value(t, n) { function callInvokeWithMethodAndArg() { return new e(function (e, r) { invoke(t, n, e, r); }); } return r = r ? r.then(callInvokeWithMethodAndArg, callInvokeWithMethodAndArg) : callInvokeWithMethodAndArg(); } }); } function makeInvokeMethod(e, r, n) { var o = h; return function (i, a) { if (o === f) throw new Error("Generator is already running"); if (o === s) { if ("throw" === i) throw a; return { value: t, done: !0 }; } for (n.method = i, n.arg = a;;) { var c = n.delegate; if (c) { var u = maybeInvokeDelegate(c, n); if (u) { if (u === y) continue; return u; } } if ("next" === n.method) n.sent = n._sent = n.arg;else if ("throw" === n.method) { if (o === h) throw o = s, n.arg; n.dispatchException(n.arg); } else "return" === n.method && n.abrupt("return", n.arg); o = f; var p = tryCatch(e, r, n); if ("normal" === p.type) { if (o = n.done ? s : l, p.arg === y) continue; return { value: p.arg, done: n.done }; } "throw" === p.type && (o = s, n.method = "throw", n.arg = p.arg); } }; } function maybeInvokeDelegate(e, r) { var n = r.method, o = e.iterator[n]; if (o === t) return r.delegate = null, "throw" === n && e.iterator.return && (r.method = "return", r.arg = t, maybeInvokeDelegate(e, r), "throw" === r.method) || "return" !== n && (r.method = "throw", r.arg = new TypeError("The iterator does not provide a '" + n + "' method")), y; var i = tryCatch(o, e.iterator, r.arg); if ("throw" === i.type) return r.method = "throw", r.arg = i.arg, r.delegate = null, y; var a = i.arg; return a ? a.done ? (r[e.resultName] = a.value, r.next = e.nextLoc, "return" !== r.method && (r.method = "next", r.arg = t), r.delegate = null, y) : a : (r.method = "throw", r.arg = new TypeError("iterator result is not an object"), r.delegate = null, y); } function pushTryEntry(t) { var e = { tryLoc: t[0] }; 1 in t && (e.catchLoc = t[1]), 2 in t && (e.finallyLoc = t[2], e.afterLoc = t[3]), this.tryEntries.push(e); } function resetTryEntry(t) { var e = t.completion || {}; e.type = "normal", delete e.arg, t.completion = e; } function Context(t) { this.tryEntries = [{ tryLoc: "root" }], t.forEach(pushTryEntry, this), this.reset(!0); } function values(e) { if (e || "" === e) { var r = e[a]; if (r) return r.call(e); if ("function" == typeof e.next) return e; if (!isNaN(e.length)) { var o = -1, i = function next() { for (; ++o < e.length;) if (n.call(e, o)) return next.value = e[o], next.done = !1, next; return next.value = t, next.done = !0, next; }; return i.next = i; } } throw new TypeError(_typeof(e) + " is not iterable"); } return GeneratorFunction.prototype = GeneratorFunctionPrototype, o(g, "constructor", { value: GeneratorFunctionPrototype, configurable: !0 }), o(GeneratorFunctionPrototype, "constructor", { value: GeneratorFunction, configurable: !0 }), GeneratorFunction.displayName = define(GeneratorFunctionPrototype, u, "GeneratorFunction"), e.isGeneratorFunction = function (t) { var e = "function" == typeof t && t.constructor; return !!e && (e === GeneratorFunction || "GeneratorFunction" === (e.displayName || e.name)); }, e.mark = function (t) { return Object.setPrototypeOf ? Object.setPrototypeOf(t, GeneratorFunctionPrototype) : (t.__proto__ = GeneratorFunctionPrototype, define(t, u, "GeneratorFunction")), t.prototype = Object.create(g), t; }, e.awrap = function (t) { return { __await: t }; }, defineIteratorMethods(AsyncIterator.prototype), define(AsyncIterator.prototype, c, function () { return this; }), e.AsyncIterator = AsyncIterator, e.async = function (t, r, n, o, i) { void 0 === i && (i = Promise); var a = new AsyncIterator(wrap(t, r, n, o), i); return e.isGeneratorFunction(r) ? a : a.next().then(function (t) { return t.done ? t.value : a.next(); }); }, defineIteratorMethods(g), define(g, u, "Generator"), define(g, a, function () { return this; }), define(g, "toString", function () { return "[object Generator]"; }), e.keys = function (t) { var e = Object(t), r = []; for (var n in e) r.push(n); return r.reverse(), function next() { for (; r.length;) { var t = r.pop(); if (t in e) return next.value = t, next.done = !1, next; } return next.done = !0, next; }; }, e.values = values, Context.prototype = { constructor: Context, reset: function reset(e) { if (this.prev = 0, this.next = 0, this.sent = this._sent = t, this.done = !1, this.delegate = null, this.method = "next", this.arg = t, this.tryEntries.forEach(resetTryEntry), !e) for (var r in this) "t" === r.charAt(0) && n.call(this, r) && !isNaN(+r.slice(1)) && (this[r] = t); }, stop: function stop() { this.done = !0; var t = this.tryEntries[0].completion; if ("throw" === t.type) throw t.arg; return this.rval; }, dispatchException: function dispatchException(e) { if (this.done) throw e; var r = this; function handle(n, o) { return a.type = "throw", a.arg = e, r.next = n, o && (r.method = "next", r.arg = t), !!o; } for (var o = this.tryEntries.length - 1; o >= 0; --o) { var i = this.tryEntries[o], a = i.completion; if ("root" === i.tryLoc) return handle("end"); if (i.tryLoc <= this.prev) { var c = n.call(i, "catchLoc"), u = n.call(i, "finallyLoc"); if (c && u) { if (this.prev < i.catchLoc) return handle(i.catchLoc, !0); if (this.prev < i.finallyLoc) return handle(i.finallyLoc); } else if (c) { if (this.prev < i.catchLoc) return handle(i.catchLoc, !0); } else { if (!u) throw new Error("try statement without catch or finally"); if (this.prev < i.finallyLoc) return handle(i.finallyLoc); } } } }, abrupt: function abrupt(t, e) { for (var r = this.tryEntries.length - 1; r >= 0; --r) { var o = this.tryEntries[r]; if (o.tryLoc <= this.prev && n.call(o, "finallyLoc") && this.prev < o.finallyLoc) { var i = o; break; } } i && ("break" === t || "continue" === t) && i.tryLoc <= e && e <= i.finallyLoc && (i = null); var a = i ? i.completion : {}; return a.type = t, a.arg = e, i ? (this.method = "next", this.next = i.finallyLoc, y) : this.complete(a); }, complete: function complete(t, e) { if ("throw" === t.type) throw t.arg; return "break" === t.type || "continue" === t.type ? this.next = t.arg : "return" === t.type ? (this.rval = this.arg = t.arg, this.method = "return", this.next = "end") : "normal" === t.type && e && (this.next = e), y; }, finish: function finish(t) { for (var e = this.tryEntries.length - 1; e >= 0; --e) { var r = this.tryEntries[e]; if (r.finallyLoc === t) return this.complete(r.completion, r.afterLoc), resetTryEntry(r), y; } }, catch: function _catch(t) { for (var e = this.tryEntries.length - 1; e >= 0; --e) { var r = this.tryEntries[e]; if (r.tryLoc === t) { var n = r.completion; if ("throw" === n.type) { var o = n.arg; resetTryEntry(r); } return o; } } throw new Error("illegal catch attempt"); }, delegateYield: function delegateYield(e, r, n) { return this.delegate = { iterator: values(e), resultName: r, nextLoc: n }, "next" === this.method && (this.arg = t), y; } }, e; }
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } // updateData
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          res = _context.sent;
          if (res.status === 200) (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " successfully updated!"));
          _context.next = 11;
          break;
        case 8:
          _context.prev = 8;
...
var bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          stripe = Stripe('pk_test_51Ns8mJJUz1iIRTj97rxCEY5oub1ZQhYF92TvnUDnq3YBawHgzXBOIZkh1El9By3ZaOCr8JoeoBHn0mGVUfpLfTYg00Q3nhxV7r');
          _context.prev = 1;
          _context.next = 4;
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          if (res.status === 200) {
            (0, _alerts.showAlert)('success', 'Confirmation link was sent to your email!');
          }
          _context.next = 11;
          break;
        case 7:
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Your review was successfully added!');
            location.reload();
          }
          _context.next = 10;
          break;
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"likeTour.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.likeTour = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /* eslint-disable */
var likeTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId, method) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
  ...
  return function likeTour(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /*eslint-disable*/
var editReview = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(review, data) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'PATCH',
            url: "http://127.0.0.1:8000/api/v1/reviews/".concat(review),
            data: data
          });
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Your review was updated successfully!');
          }
          _context.next = 10;
          break;
        case 7:
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"createTour.js":[function(require,module,exports) {
"use strict";
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Tour was created successfully!');
            window.setTimeout(function () {
              location.reload();
            }, 1500);
          }
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"deleteDoc.js":[function(require,module,exports) {
"use strict";
...
var deleteDoc = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(model, id) {
    var url, res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          url = "http://127.0.0.1:8000/api/v1/".concat(model, "/").concat(id);
          _context.next = 4;
          return (0, _axios.default)({
            method: 'DELETE',
            url: url
        ...
        case 4:
          res = _context.sent;
          if (res.status === 204) {
            (0, _alerts.showAlert)('success', 'Document was deleted successfully!');
            window.setTimeout(function () {
              location.reload();
            }, 1500);
          }
  ...
  return function deleteDoc(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
exports.deleteDoc = deleteDoc;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"updateDoc.js":[function(require,module,exports) {
"use strict";
...
var updateDoc = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(model, id, data) {
      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return _axios.default.patch(url, data, {
            headers: {
              'Content-Type': model === 'tours' ? 'multipart/form-data' : 'application/json'
            }
          });
        case 4:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Document was updated successfully!');
            window.setTimeout(function () {
              location.reload();
            }, 1500);
          }
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"createUser.js":[function(require,module,exports) {
"use strict";
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _axios.default.post('http://127.0.0.1:8000/api/v1/users', data, {
            headers: {
              'Content-Type': 'application/json'
            }
          });
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'User was created successfully!');
            window.setTimeout(function () {
              location.reload();
            }, 1500);
          }
...
var _likeTour = require("./likeTour");
var _editReview = require("./editReview");
var _createTour = require("./createTour");
var _deleteDoc = require("./deleteDoc");
...
var btnHeart = Array.from(document.querySelectorAll('.btn-heart'));
var btnEdit = Array.from(document.querySelectorAll('.edit__button'));
var btnClose = Array.from(document.querySelectorAll('.close__button'));
var btnCreate = document.querySelector('.btn-create');
var formEditReviewContainer = document.getElementById('my-reviews-form');
var formEditReview = document.querySelector('.edit-review-form');
var createTourForm = document.querySelector('.create-form');
var overlay = document.querySelector('.overlay');
var closeOverlayBtn = document.querySelector('.close-overlay');
var btnDelete = Array.from(document.querySelectorAll('.btn-delete'));
var btnEditDoc = Array.from(document.querySelectorAll('.btn-edit'));
var updateTourForm = document.querySelector('.update-form');
var createUserForm = document.querySelector('.create-user-form');
var passwordToggleBtn = Array.from(document.querySelectorAll('.password-toggle'));
...
if (signUpForm) {
  signUpForm.addEventListener('submit', function (e) {
    ...
    var email = document.getElementById('email').value;
    var password = document.getElementById('password').value;
    var passwordConfirm = document.getElementById('password__Confirm').value;
...
if (formReview) {
  formReview.addEventListener('submit', function (e) {
    e.preventDefault();
    var ratingInputs = Array.from(document.querySelectorAll('.input__rating')).filter(function (el) {
      return el.checked;
    })[0];
    var tourId = document.getElementById('review-btn').dataset.tourId;
    var data = {
      review: document.getElementById('review-details').value,
      rating: ratingInputs.value,
      tour: tourId
    };
    (0, _review.sendReview)(data);
  });
}
if (btnHeart.length) {
  btnHeart.forEach(function (btn) {
    return btn.addEventListener('click', function (e) {
      this.classList.toggle('favourite');
      var tourId = this.dataset.tourId;
      var method = this.classList.contains('favourite') ? 'add' : 'remove';
      (0, _likeTour.likeTour)(tourId, method);
    });
  });
}
if (btnEdit.length) {
...
if (formEditReviewContainer) {
  formEditReview.addEventListener('submit', function (e) {
    ...
    (0, _editReview.editReview)(reviewId, data);
  });
}
...
if (createTourForm) {
  createTourForm.addEventListener('submit', function (e) {
    ...
    var duration = document.getElementById('tour-duration').value;
    var maxGroupSize = document.getElementById('tour-group-size').value;
    var difficulty = document.getElementById('tour-difficulty').value;
    var price = document.getElementById('tour-price').value;
    var summary = document.getElementById('tour-summary').value;
    var description = document.getElementById('tour-description').value;
    var guides = Array.from(document.getElementById('tour-guides').selectedOptions).map(function (option) {
      return option.value;
    });
    var startDates = document.getElementById('tour-startDate').value;
    var startLocation = document.getElementById('tour-Location').value;
    ...
    for (var _i = 0; _i < guides.length; _i++) {
      form.append('guides', guides[_i]);
    }
...
if (btnCreate) {
  btnCreate.addEventListener('click', function (e) {
    ...
    document.querySelector('.form-heading').textContent = "Fill the fields to create a ".concat(model, "!");
...
if (btnDelete.length) {
  btnDelete.forEach(function (btn) {
    return btn.addEventListener('click', function (e) {
      ...
      (0, _deleteDoc.deleteDoc)(model, id);
    });
  });
}
...
if (btnEditDoc.length) {
  btnEditDoc.forEach(function (btn) {
    btn.addEventListener('click', function (e) {
      overlay.classList.remove('hidden');
      document.querySelector('.form-heading').textContent = 'Fill the fields that you want to update!';
      var model = this.dataset.model;
      var id = this.dataset.id;
      if (updateTourForm) {
...
if (updateTourForm) {
  updateTourForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var emptyFields = [];
    var form = new FormData(updateTourForm);
    var model = this.dataset.model;
    var id = this.dataset.id;
    ...
    try {
      for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
        ...
        if (_pair[0] === 'imageCover' || _pair[0] === 'images') {
          if (!_pair[1].name) emptyFields.push(_pair[0]);
        }
      }
    } catch (err) {
      _iterator2.e(err);
    ...
    emptyFields.forEach(function (el) {
      return form.delete(el);
    });
    (0, _updateDoc.updateDoc)(model, id, form);
  });
}
if (createUserForm) {
  createUserForm.addEventListener('submit', function (e) {
    ...
    if (this.dataset.model || this.dataset.id) {
      ...
      var _iterator3 = _createForOfIteratorHelper(_form.entries()),
        _step3;
      try {
      ...
      emptyFields.forEach(function (el) {
        return _form.delete(el);
      });
      (0, _updateDoc.updateDoc)(this.dataset.model, this.dataset.id, _form);
      return;
    }
    this.dataset.model = '';
    this.dataset.id = '';
    ...
    try {
      for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
        var _pair2 = _step4.value;
        if (_pair2[0] === 'photo') {
          if (!_pair2[1].name) form.delete('photo');
        }
      }
    } catch (err) {
      _iterator4.e(err);
    ...
    (0, _createUser.createUser)(form);
  });
}
if (passwordToggleBtn.length) {
  passwordToggleBtn.forEach(function (btn) {
